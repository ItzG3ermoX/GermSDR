...
export class WaterfallRenderer {
    ...
    textureWidth;
    height;
    constructor(canvas, fftSize, historyRows = 640) {
        this.canvas = canvas;
    ...
    pushRow(bins) {
        ...
        gl.texSubImage2D(gl.TEXTURE_2D, 0, 0, this.writeRow % this.height, this.textureWidth, 1, gl.RED, gl.UNSIGNED_BYTE, this.rowBuffer);
        this.writeRow += 1;
    }
    draw(dbMin, dbMax) {
        const gl = this.gl;

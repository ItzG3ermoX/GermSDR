...
import { connectAudio, connectWaterfall } from './ws-client';
import { formatFrequency, gainValue, getUi, refreshIcons, selectedMode, selectedPalette, setMode, } from './ui';
const ui = getUi();
let renderer;
...
let lastSeq = 0;
function ensureRenderer(fftSize) {
